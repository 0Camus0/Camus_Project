#ifndef T1000_DESCRIPTORS_H
#define T1000_DESCRIPTORS_H

#include <Video/ShaderBase.h>

namespace t1000 {
namespace T_BUFFER_USAGE{
  enum E {
    DEFAULT,
    DINAMIC,
    STATIC
...
enum T_TEXT_BASIC_FORMAT {
  CH_ALPHA = 1,
  CH_RGB = 2,
  CH_RGBA = 4
};

enum T_TEXT_BASIC_PARAMS {
  TILED = 1,
  CLAMP_TO_EDGE = 2,
  MIPMAPS = 4
};

enum T_Signature : unsigned long long {
  // ATTRIBUTES
  HAS_NORMALS				= 0x1,
  HAS_TANGENTS				= 0x2,
  HAS_BINORMALS				= 0x4,
  ...
  struct BufferDesc {
    int byteWidth;
    T_BUFFER_USAGE::E usage;
  };

  struct ApplicationDesc {
    T_GRAPHICS_API::E api;
    T_VIDEO_MODE::E videoMode;
    unsigned int width;
    unsigned int height;
    std::string title;
    ApplicationDesc() {
      api = T_GRAPHICS_API::_D3D11;
      width = 1280;
      height = 720;
      title = "My New Project";
      videoMode = T_VIDEO_MODE::WINDOWED;
    }
  };

  struct InputElement {
    std::string name;
    t1000::shader::datatype_ type;
    int loc;
    int num;
    int size;
