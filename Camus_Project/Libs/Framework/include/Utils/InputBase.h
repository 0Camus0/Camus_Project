...
#define MAX_NUM_OF_TRACKING_POINTERS 4
	...
	public:
		...
		void	FillTouchCoords(T x, T y, int id) {
			devices[hyperspace::TypeInput_::TOUCH_SCREEN].currentcoords[id].factual_coords[0] = x;
			devices[hyperspace::TypeInput_::TOUCH_SCREEN].currentcoords[id].factual_coords[1] = y;
		}

		// TODO: Implement other input Devices.
		//void InitJoypad...

		std::vector<hyperspace::InputEvent_>		queue;
		hyperspace::InputDevice_					devices[hyperspace::TypeInput_::NUM_DEVICES];
