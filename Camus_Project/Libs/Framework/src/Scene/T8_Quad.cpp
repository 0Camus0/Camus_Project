...
namespace t1000 {
  ...
  void Quad::Init()
  {
    ...
    m_VB = (t1000::VertexBuffer*)T8Device->CreateBuffer(T_BUFFER_TYPE::VERTEX, bdesc, m_vertex);


    bdesc.byteWidth = 6 * sizeof(unsigned short);
    bdesc.usage = T_BUFFER_USAGE::DEFAULT;
    m_IB = (t1000::IndexBuffer*)T8Device->CreateBuffer(T_BUFFER_TYPE::INDEX, bdesc, m_index);
  }
  ...
  void Quad::Set()
  {
    ...
    m_IB->Set(*T8DeviceContext, 0, T_IB_FORMAT::R16);
  }
}